...
export function canViewNavigationTab(role, tabId) {
    const tabPermissions = {
        ...
        'performance': [PERMISSIONS.VIEW_ALL_EMPLOYEES, PERMISSIONS.VIEW_DEPARTMENT_EMPLOYEES], // Admin/Manager için
        ...
        'gamification': [PERMISSIONS.VIEW_ALL_EMPLOYEES, PERMISSIONS.VIEW_DEPARTMENT_EMPLOYEES], // Admin/Manager için oyunlaştırma
        'kudosfeed': [PERMISSIONS.VIEW_ALL_EMPLOYEES, PERMISSIONS.VIEW_DEPARTMENT_EMPLOYEES], // Admin/Manager için kudos akışı
